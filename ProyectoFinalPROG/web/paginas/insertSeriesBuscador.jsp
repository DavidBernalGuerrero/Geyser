...
<html>
  ...
  <body>
    ...
    <%
      ...
      if (request.getParameter("columna") == null) {
        consulta = "SELECT * FROM Series WHERE TITULO LIKE '%" + request.getParameter("buscador") + "%'";
      } else {
        consulta = "SELECT * FROM Series '%" + request.getParameter("buscador") + "%' ORDER BY " + 
 ...
 <a style="float: left; margin: 2.5em 0;" class="btn btn-danger" href="insertSeries.jsp" role="button">Quitar Filtro</a>            
    </footer>
  </body>
</html>
